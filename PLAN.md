...
| `psy-superviseur` | Contre-expertise : challenge les conclusions du thérapeute, détecte l'effet miroir | ⏸️ non planifié — **seul rôle manquant** |

> ⭐ **Les six rôles opérationnels existent depuis le 09/08/2026.** Ce qui manquait n'était ni la doctrine ni les fiches : c'était **l'exécutant**. Un protocole de crise sans skill de crise est un document que personne n'ouvre au moment où il sert ; des instruments d'échelle sans skill de passation sont un corpus qu'on ne fait pas passer. **Reste `psy-superviseur`** — le garde-fou anti-effet-miroir, et le seul rôle dont l'absence ne se voit pas, par construction.
...
- [ ] 🔴 **Démarrer le check-in quotidien immédiatement** (Claude Code, migré sur Android à l'étape 5) — c'est la seule façon d'arriver au 03/09 avec des données observées plutôt qu'avec des souvenirs
