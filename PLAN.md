...
- [ ] **Envoyer l'email au Dr Isorni** — rédigé, non envoyé. **Seul praticien encore dans l'ignorance des deux diagnostics somatiques**, et **dernier point ouvert du palier 0**
...
| ⏱️ `fiche-chourouk` *(`montrable: true`)* — **une version plus récente que celle publiée attend** | `crise` | [fiche-chourouk.md](aidant/ressources/fiche-chourouk.md) | Republier ne la transmet pas — **la transmission est à l'Étape 7** |
...
| `sejour-tunisie` | `therapie` | [PLAN.md](PLAN.md) §3 | Aucune progression de palier sur place, redescente d'un palier au retour |
...
- [ ] Passer les échelles restantes : **TAS-20** · **CAT-Q** · **GAD-7 / PHQ-9** · **BES** · **MAIA-2**. Plafond 20 min par séance ; **l'échelle n'est jamais la cible de la séance**. ⭐ **En conversation avec Claude Psy** — Kokoro porte le bilan, jamais la passation
...
### Étape 6 — Kokoro ✅ *Terminée*

### Étape 7 — Stabilisation à deux, puis réouverture de l'EMDR ⏸️

- [ ] **Transmettre la fiche à Chourouk** — [`fiche-chourouk.md`](aidant/ressources/fiche-chourouk.md) porte le rôle, le « non » de la main, les critères d'arrêt et le mode entraînement. 🔴 **Supervision bloquante, note interne à retirer, et Xavier relit et décide.** 🔴 **Elle a cessé d'être une bonne pratique pour devenir une dépendance de conception** *(19/08/2026)* : les critères d'arrêt se cochent avant d'entrer et ne sont plus rappelés pendant la séquence — **la fiche porte désormais, hors écran, ce que l'écran ne rappelle plus**
