...
| Un pourcentage d'observance, une série, un compteur de régularité, un rattrapage | ⛔ Interdit au dossier (`psy/DOSSIER.md` §9). Le télésuivi sert à **ajuster les réglages**, pas à noter le patient. |
