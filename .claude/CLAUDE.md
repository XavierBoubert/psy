...
| `Rapport psychiatrique et psychologique.md` | Rapport de synthèse complet généré par Claude (08/08/2026) à partir de toutes les ressources ci-dessus + DSM-5 + littérature en ligne : fiche patient détaillée, chronologie, anamnèse, re-cotation indépendante AQ (39/50) et EQ (9/80), analyse critérielle DSM-5 (TSA niveau 1 confirmé, agoraphobie avec attaques de panique), confirmation du diagnostic d'Emeline Saley, 13 enseignements et recommandations. Sert de document de référence du profil de Xavier |
