...
**Statut :** plan de construction — **v1.4 (10/08/2026)**. Ouvre l'**Étape 5** du `PLAN.md` racine. ✅ **K0, K1 et K2 franchis le 10/08/2026.**
...
| **Le SMS est composé et prêt à envoyer** | Écran « À Chourouk / **shutdown** / Envoyer » · `deviceLocked=1` · 🔒 **le bouton n'a pas été pressé** — voir la réserve ci-dessous |
...
>
> 🔴 **Réserve, et elle est entière : aucun SMS n'a été réellement envoyé.** La vérification s'est faite avec un **numéro fictif**, effacé depuis — l'app affiche « Aucun numéro enregistré ». **Il reste donc deux actes, et ils appartiennent à Xavier :** (1) saisir le vrai numéro de Chourouk dans l'écran de réglage, (2) **faire un envoi réel, à froid, en la prévenant** — c'est le seul moyen de vérifier que le message part, qu'il arrive, et qu'elle le reçoit sous la forme attendue. **Un porteur de mot-code jamais essayé n'est pas un porteur de mot-code.**
>
