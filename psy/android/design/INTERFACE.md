...
| **Bibliothèque** | **0 fiche** | Le README seul. 🔴 Les 8 protocoles de `psy/protocoles/` **ne se copient pas** (C9) — ils se réécrivent pour Xavier |
...
Aucun score · aucune progression · aucun historique · aucun palier atteint · aucun streak · aucune notification ni relance · aucun numéro d'urgence, **3114 compris** · le PHQ-9 · rien de `psy/dossier/` (profil, état, séances, mesures, briefs) · aucune police, aucun service, aucune image venus d'ailleurs.
