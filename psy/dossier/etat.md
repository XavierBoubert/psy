...
**Dernière mise à jour :** 09/08/2026 *(v1.11 — arbitrages de la supervision exécutés : fiche Chourouk, MAIA, app tension en Étape 5)* · **Prochaine révision :** à la première séance de fond.
...
| **MAIA** | ⭐ Intéroception — **adosser la règle §9.19**, la plus citée du dispositif et la seule sans mesure | 10 min | ⚠️ **partiel** — items non obtenus ; **grille comportementale de 5 questions** → [`maia.md`](../corpus/echelles/maia.md) §5 | Grille : **16/08**, avec la TAS-20 *(les deux se complètent — émotions et corps)* |
