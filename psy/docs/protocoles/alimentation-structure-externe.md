...
**Ce qui reste à faire : passer la BES** (Binge Eating Scale, Gormally 1982 — 16 items, ~10 min). Passation programmée à l'**Étape 2** avec les autres échelles ; instrument à verser dans `psy/docs/corpus/echelles/`. Résultat à écrire dans `mesures/AAAA-MM-JJ-bes.json`.
