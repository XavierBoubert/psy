...
Un épisode → `crises/AAAA-MM-JJ-HHMM-panique.json` (cf. `SCHEMA.md` §4). Champs qui comptent ici : `contexte` (`transport`, `foule`, `lieu_clos`), `parade_utilisee`, `perte_de_connaissance`.
