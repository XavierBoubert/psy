...
Elles viennent du rapport v2.4. **Aucune n'est une préférence** *(détail : [`../PLAN.md` §2](../PLAN.md#2-xavier--les-contraintes-qui-commandent-tout))* :
...
| **Deux mécanismes de crise distincts** | Panique *(exposition/respiration)* ≠ vasovagal *(tension appliquée)*. **La mauvaise parade aggrave.** *(Un troisième, le shutdown, a sa propre parade.)* |

> ⭐ **La règle centrale — signal interne absent → structure externe** *(`PLAN.md` §9.19)*. Ne jamais demander à Xavier de s'appuyer sur une perception qui lui manque : satiété, fatigue, tension, émotion. **Trois échecs documentés** — « imaginez un lieu sûr », « écoutez votre satiété », « portez le masque toute la nuit » — **relevaient de la conception, pas de la volonté.**
>
