...
Un outil de **comptage**, pas de jugement — par exemple : combien de fiches écrites contre combien de fois appliquées *(la mesure de C7)*, ou combien d'objections substantielles tracées sur la période *(la mesure de C5)*. **Ces deux contrôles se comptent ; les huit autres se lisent.**

> 🔴 **Aucun script de ce répertoire n'aura jamais le droit de publier, de corriger, ni de lever un refus.** Le superviseur constate ; **la correction est un acte séparé.**
