...
> ⭐ **L'écran de crise du monde porte un personnage** : la posture `accoude`, panneau **allumé**, accoudé au bouton *Mot code*, la tête penchée de 6° — motif *« Kokoro veille sur toi »*. Détail, motifs et six bornes au [§10.2](#102--kokoro-veille-sur-toi--la-dérogation-de-lécran-de-crise-arbitrée-le-16082026). 🔴 **La borne qui compte : aucun panneau de crise n'en porte** — ni la tension appliquée, ni la phrase pour le soignant, ni le mot-code —, et un test de sources l'interdit. ⭐ **La notification ouvre cette scène-là, figée** *(Xavier, 18/08/2026)* : même décor sans parallaxe, même personnage sans animation.
>
...
- **Cycle :** ⭐ **3,8 s** inspiration + expiration *(demande de Xavier, 16/08/2026 — « un petit peu plus vite » ; 4,5 s auparavant)*, sinusoïde continue, aucun temps d'arrêt. Soit 16 souffles par minute au lieu de 13.
- **Amplitude :** le ventre grossit **vers le haut uniquement** *(demande de Xavier, 16/08/2026 — remplace 2 % de hauteur + 1 % de rétraction en largeur)*, autour de sa base. ⚠️ **×1,18, et non le ×1,03 d'origine** : Xavier a demandé ×1,03, puis *« on ne le voit pas respirer »*, puis *« augmente vraiment »*. **Les trois sont vrais** — le mouvement de référence à l'écran est la lévitation, **10 dp** ; ×1,03 ne donnait que 1,1 dp de montée de tête, soit 11 % d'elle. À ×1,18 la tête monte de **6,5 dp**, les deux tiers. ⏳ **Une seule valeur à changer** pour le rendre plus discret. ⭐ **La ligne du ventre et le 心 sont dessus, donc ils suivent** — c'est le 心 qui monte et descend, et c'est l'ancre visuelle du souffle depuis que la plaque a disparu. 🔄 **La tête et les bras suivent** *(16/08/2026)* : ils montent et descendent avec le sommet du ventre, pour rester à la même hauteur de lui qu'au repos, au lieu de s'y enfoncer. **Les pieds, eux, ne bougent pas.**
- 🔴 **Le rythme ne change jamais.** Ni plus vite, ni plus lent, ni en fonction de quoi que ce soit. **Une respiration qui varie devient une information à décoder** — et une information non demandée qui prétend parler de l'état de Xavier est exactement ce que §5.7 interdit. *(Régler la période une fois pour toutes n'est pas la faire varier : ce que l'invariant refuse, c'est qu'elle dépende de quelque chose.)*
- 🔄 **Une seule surface l'arrête, et c'est l'écran de crise du monde** *(demande de Xavier, 16/08/2026 — §10.2 borne 3)* : accoudé, **il ne respire pas non plus.** ⭐ **C'est l'amplitude qui tombe, pas l'horloge** — le souffle s'éteint en 800 ms jusqu'au corps du dessin, sans saut, et il revient dès qu'il repart. **Le clignement, lui, reste** : c'est l'axe des yeux, pas celui du corps.
...
- 🔄 **La respiration a sa propre horloge, détachée de celle du vol** *(demande de Xavier, 16/08/2026 : « non calée sur la vitesse du haut/bas pour faire plus réelle »)*. Jusqu'ici le corps n'avait qu'une seule horloge, partagée par déphasage avec la lévitation de `PRESENCE.md` — précisément pour qu'aucun battement lent ne naisse entre les deux. **C'est cette dérive-là que Xavier demande** : souffle et vol stationnaire ne culminent plus jamais ensemble. **Le vol garde son horloge propre** — un tour vaut toujours deux respirations, et le sommeil en divise la phase par deux.
...
| 6 | 🆕 **`pensif`** | Le dessin, **aucun geste** — 🔄 **et plus aucune lecture** *(demande de Xavier, 16/08/2026)* : les yeux parcouraient la liste, ils n'en font plus rien. **Il ne reste que la respiration** | `serein` **+ regard baissé** | Écran de thérapie, avant 18 h | Rien |
| 7 | 🆕 **`lecture`** | Bras gauche avancé vers le bas ; 🔄 **le bras droit de Kokoro, lui, est plié, main contre son menton** *(demande de Xavier, 16/08/2026 — §8 point 2)* ; balayage des yeux gauche → droite, retour bref | `serein` **+ regard baissé** | Au-dessus d'une liste de fiches | Rien |
...
| 10 | 🆕 **`sommeil`** | Yeux fermés au repos, lévitation à demi-vitesse, Zzz en fondu ; 🔄 **bras et pieds à la pose lue dans `kokoro-corps-v2-sleep.svg`** *(demande de Xavier, 16/08/2026 — §9)* | `veille` *(réutilisée, pas une septième)* | Une liste est vide | Le cadre vide, **qui reste affiché** |
...
2. **Faire signe, lever un bras au-dessus de l'épaule, applaudir, lever le pouce.** Le pouce levé est une **évaluation** ; l'évaluation est interdite. *(La désignation du §6 est bornée à la ligne des épaules. 🔄 Une seconde exception, nommée, s'y ajoute le 16/08/2026 : le bras droit de Kokoro en `lecture`, main contre son menton — §7 n° 7. Un geste tourné vers lui-même, jamais vers le lecteur, donc pas le salut que ce point exclut.)*
...
|---|---|---|
| `head-out`, `head-in` | ⭐ **Milieu des épaules** — `(120,0 ; 111,1)` | 🔄 **La rotation, rien sauf `accoude`** *(16/08/2026)* : la tête y penche de 6°, **coque, panneau et visage ensemble**. Partout ailleurs elle ne tourne pas. Le pivot n'est pas choisi : les deux ancres d'épaules sont **le seul point que le dessin désigne entre elles**. 🔄 **La translation, elle, suit partout** *(16/08/2026)* : la tête monte et descend avec le souffle, comme les bras (§5). `head-in` s'allume et s'éteint |
| `eye-right`, `eye-left`, `mouth` | — | ⭐ **Morphing** : la forme se déforme vers la suivante *(voir ci-dessous)*. **Jamais deux visages superposés** |
| `body-form`, `body-line`, `kanji-1…4` | **Base du corps** — `(120,0 ; 169,4)` | Respiration, **et le corps resserré du vol** *(16/08/2026)* : ×0,940 en largeur, ×1,037 en hauteur, autour de `(120,1 ; 132,3)`. Les six pièces bougent ensemble |
| `arm-right`, `arm-left` | ⭐ **Épaule** — `(80,6 ; 111,1)` et `(159,3 ; 111,1)` | Désignation (§6), **bornée à +70,5°** |
| `foot-right`, `foot-left` | ⭐ **Centre du ventre** — `(119,8 ; 137,7)`, le même pour les deux | 🔄 **Le sommeil et le vol s'en servent, chacun sur un pivot propre dérivé** *(16/08/2026)* : la pose est lue dans `kokoro-corps-v2-sleep.svg` et `kokoro-corps-v2-right.svg` (§11 point 4), pas choisie ici. Le vol vers la gauche est le calcul inverse de celui vers la droite. Rien d'autre ne s'en sert |

> 🔄 **Le vol prend le dessin en entier — les douze pièces, pas les quatre membres** *(16/08/2026, après trois passes ratées)*. `kokoro-corps-v2-right.svg` n'est pas la pose de repos avec les bras déplacés : c'est **un autre dessin du personnage**, et c'est la tête qui le dit. **Coque et panneau s'y resserrent vers la droite** *(×0,872 et ×0,752, autour de x ≈ 175 et 205)*, **les yeux se rapprochent en glissant du même côté** *(+37 et +27, soit 10 unités d'écart en moins)*, la bouche suit *(+34)*, le corps s'affine et s'allonge *(×0,940 et ×1,037)*, le 心 glisse de 3,2 unités dedans, et les membres tournent. 🔴 **Le trois-quarts de la tête vient de là, et il ne déroge pas au §2** : rien ne tourne, tout se resserre — le corps reste de face, c'est un raccourci, pas une perspective.
>
> ⚠️ **Ce qui rendait le vol méconnaissable, c'est d'en avoir pris une part.** Les rotations de bras seules, **ajoutées** à la posture en cours, laissaient un bras tendu vers *Aujourd'hui* et un dormeur dont seuls les pieds partaient de côté. **Le vol remplace la posture, il ne s'y ajoute pas** : ouverture des bras, pose de sommeil et regard s'éteignent à mesure que le dessin les reprend à son compte.
>
> ⭐ **Rien n'est choisi**, comme partout ailleurs : chaque valeur est la matrice de la variante rapportée à celle du repos, et `VolInvariantsTest` recompose les douze pièces à chaque build. Le pivot du corps tombe **à trois dixièmes de ceux des pieds**, décomposés séparément — le dessin se recoupe tout seul.
>
> 🔴 **La réserve tient toujours pour le sommeil** : `kokoro-corps-v2-sleep.svg` ne donne que ses bras et ses pieds.
...
| 🔄 **Écran de crise — hors du monde** *(`CriseActivity`, ouvert par la notification)* | ⭐ **La scène du monde, figée** | 🔄 **Xavier, 18/08/2026 : une seule porte, un seul écran.** `CriseActivity` affiche `SceneDeCrise` — même décor **sans parallaxe**, même `accoude` **sans transit, sans souffle et sans clignement**, mêmes trois boutons |
| 🔴 **Panneaux de crise** — mot-code, tension appliquée, phrase pour le soignant | ❌ **absent** | 🔴 **Aucun personnage, et un test de sources l'interdit.** Ce qui s'ouvre **quand ça va déjà mal** ne porte pas de compagnon : hors du monde, `LocalPanneauPorte` vaut `false` — ni queue de bulle, ni Kokoro dessous, et le panneau descend jusqu'en bas |
...
| **Où** | Ambigu — le §2 disait l'écran du monde, la liste de fichiers disait `CriseActivity` | 🔄 **L'écran de crise, des deux côtés** — le monde, et la même scène figée sous la notification *(18/08/2026)*. **Jamais un panneau** |

> ✅ **Le contre-argument avait raison, et l'usage l'a tranché** *(Xavier, 18/08/2026)*. La supervision demandait *« les deux portes, sinon `INTERFACE.md` §6.2 tombe »* ; le 16/08 une seule l'avait reçu, et les deux portes ne se ressemblaient plus. **Elles se ressemblent de nouveau, à la lettre** : la notification affiche la scène du monde. ⭐ **Ce qui reste du partage clinique est le mouvement, pas la présence** — la scène de la notification ne bouge pas : **ni parallaxe, ni transit, ni souffle, ni clignement.** On ne s'impose pas par-dessus le verrouillage avec quelque chose qui remue.

🔴 **Les six bornes de la dérogation, et un test tient chacune :**

1. 🔄 **Cette scène-ci, et elle seule** *(rouvert par Xavier le 18/08/2026)*. **La notification ouvre la même scène, figée** — c'est une seule porte affichée deux fois, plus deux écrans à distinguer. **Les panneaux, eux, n'en portent toujours aucun** : ni mot-code, ni tension appliquée, ni phrase pour le soignant. **Un test de sources refuse tout personnage dessiné dans `crise/`** et vérifie que `CriseActivity` pose `LocalPanneauPorte` à `false`, parce que le risque n'est pas d'en ajouter un exprès : c'est qu'il y arrive par la valeur par défaut d'un paramètre.
...
3. **Il ne vole pas, et une fois posé il ne respire pas** — seule place du dispositif dans ces deux cas. **Il est accoudé, pas posé au sol** : le faire léviter ferait glisser ses bras le long du bord, et **son ombre tomberait sur l'interface**. 🔄 **Son arrivée est une chorégraphie à elle** *(demande de Xavier, 16/08/2026)* : il sort de derrière le bouton **bras dressés à la verticale**, et les laisse **s'affaisser sur la seconde moitié de la sortie** — le geste commence à mi-course et **se termine avec l'arrivée du corps**, en un seul mouvement. ⚠️ **Deux choses le rendaient invisible, et les deux sont de la géométrie** : à 45° les bras ne franchissent jamais l'arête *(ils pivotent aux épaules, qui n'y arrivent qu'à la fin)*, et **la coupe des bras suivait cette même arête**, donc tout le geste se jouait dessous. **Verticaux, et la coupe laissée à sa place d'arrivée**, ils la franchissent à mi-montée — exactement quand ils commencent à descendre. 🔄 **Puis plus rien ne bouge** *(§5)* : ni vol, ni souffle — seul le clignement reste. 🔄 **Et il repart par où il est venu** *(Xavier, 18/08/2026)* : ouvrir un panneau depuis la crise **rejoue l'entrée à l'envers** — il redescend derrière le bouton en relevant les bras, au lieu de glisser hors du champ par la droite comme partout ailleurs. **Une seule chorégraphie, jouée dans les deux sens.** ⚠️ **Les bras levés ne sont qu'un passage** — aucune posture ne les porte, `accoude` rend toujours l'horizontale, et un test tient les deux bouts.
...
3. **Elle ne s'étend à aucun écran.** L'illustration vit dans le volet de notifications et **nulle part ailleurs** — ce qu'ouvre la notification est la scène de crise du monde *(§10.2)*, jamais cette image-ci. 🔴 **La règle tient là où elle compte : aucun panneau de crise ne porte de personnage**, et ce n'est pas une phrase, c'est un test de sources.
...
4. ✅ **Tranché le 16/08/2026 : le sommeil et le vol.** Xavier avait placé le pivot des pieds dans le ventre sans lui donner d'usage ; c'est désormais `sommeil` et le vol vers la droite/la gauche qui s'en servent (§9), chacun sur un angle propre lu dans un autre dessin. `allonge` reste à dessiner, mais ce n'est plus elle qui répond à ce point.
