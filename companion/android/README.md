...
>
> ⭐ **Le monde existe depuis le 14/08/2026** — **quatre écrans en anneau horizontal et sans bout** *(rangement refait le 15/08/2026, [`INTERFACE.md`](../INTERFACE.md) §7.7)*, un décor peint en quatre couches glissées en parallaxe, verrou portrait. **On arrive sur la thérapie, où Kokoro se tient** ; ce qu'on pose sur les écrans se décide en séance. **Le geste ne s'interrompt pas** : la caméra colle au doigt, et un ressort la reprend à la vitesse qu'elle avait. ⭐ **Le décor passe en nuit sur une plage horaire** — 21 h → 6 h par défaut, réglable et désactivable dans l'écran de contrôle ; **lue à l'arrivée, jamais bascule sous les yeux**, et jamais suivie sur le thème du système. Spécification : [`design/DECOR.md`](../DECOR.md).
>
