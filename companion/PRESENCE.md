...
2. ✅ **Annonce faite le 18/08/2026, validée par Xavier** — la table du §5 lui a été lue en toutes lettres, les trois surfaces nommées *(monde, check-in, réglages)* et la dérogation de l'écran de crise avec elles. **Le constat 4 de la supervision du 15/08 est levé** ; les poses restent conditionnées à une annonce, celle-ci ne vaut que pour ce qui est déjà installé.
