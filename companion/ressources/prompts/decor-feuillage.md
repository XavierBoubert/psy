LAYER 4 of 4 — FOREGROUND FOLIAGE. The nearest, darkest, fastest layer.

Large leaves and blossoms rising from the BOTTOM EDGE of the frame, close to the viewer.

- The foliage occupies only the LOWEST THIRD of the frame. Everything above it is FLAT PURE MAGENTA #FF00FF.
- Big, simple, rounded leaves — the size of a hand, not of a fingernail — growing upward and outward
  from below the bottom edge, cut off by it. Ten to fifteen leaves in the whole width, no more.
- Deep teal-blue for the leaves, the darkest value of the whole decor, with a lighter teal on a few of
